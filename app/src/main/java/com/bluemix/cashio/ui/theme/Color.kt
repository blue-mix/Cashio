...
//
//// === Brand Core ===
//val CashioPrimary = Color(0xFF6356E5) // main brand purple (indigo)
//val CashioPrimaryDark = Color(0xFF4336C4) // darker variant
//val CashioPrimarySoft = Color(0xFFE2E0FF) // soft background accent
//
//val CashioSecondary = Color(0xFF7B7EA8) // muted lavender / slate
//val CashioSecondarySoft = Color(0xFFE2E3F5)
//
//// Optional highlight / CTA accent
//val CashioTertiary = Color(0xFFF59E0B) // warm amber
//val CashioTertiarySoft = Color(0xFFFFE8B4)
//
// === Semantic Colors ===
...
//
//// === Neutrals (for charts, borders, etc.) ===
//val NeutralGrayLight = Color(0xFF9CA3AF)
//val NeutralGrayDark = Color(0xFF4B5563)
//
//// Light Mode Colors
//val md_theme_light_primary = CashioPrimary            // #6356E5
//val md_theme_light_onPrimary = Color(0xFFFFFFFF)
//val md_theme_light_primaryContainer = CashioPrimarySoft   // #E2E0FF
//val md_theme_light_onPrimaryContainer = Color(0xFF171356)
//
//val md_theme_light_secondary = CashioSecondary           // #7B7EA8
//val md_theme_light_onSecondary = Color(0xFFFFFFFF)
//val md_theme_light_secondaryContainer = CashioSecondarySoft  // #E2E3F5
//val md_theme_light_onSecondaryContainer = Color(0xFF191A2C)
//
//val md_theme_light_tertiary = CashioTertiary            // #F59E0B
//val md_theme_light_onTertiary = Color(0xFF231600)
//val md_theme_light_tertiaryContainer = CashioTertiarySoft   // #FFE8B4
//val md_theme_light_onTertiaryContainer = Color(0xFF281800)
//
//val md_theme_light_error = ExpenseRed                   // #EF4444
...
//val md_theme_dark_onPrimaryContainer = CashioPrimarySoft // #E2E0FF
//
...
//val md_theme_dark_onSecondaryContainer = Color(0xFFE2E3F5)
//
...
//val md_theme_dark_onTertiaryContainer = Color(0xFFFFE8B4)
//
...
//
//val md_theme_dark_surface = Color(0xFF0B0C18)          // neutral, not pure purple
...
//val md_theme_dark_inversePrimary = CashioPrimary        // #6356E5
package com.bluemix.cashio.ui.theme
